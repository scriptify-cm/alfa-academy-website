...
export function ContactSection() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Téléphone",
      value: info("phone"),
      href: `tel:${info("phone").split(" / ")[0].replace(/[()+ ]/g, "")}`,
    },
    {
      id: "location",
      ...
      title: "Adresse",
      value: info("location"),
      href: `https://maps.google.com/?q=${info("location")}`,
    },
  ]
      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-3 gap-12">
                ...
                <form className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="email" type="email" placeholder={form("email")} />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="subject">{form("subject")}</Label>
                    <Input id="subject" placeholder={form("subject")} />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="message">{form("message")}</Label>
                    <Textarea id="message" placeholder={form("message")} rows={5} />
                  </div>
                  <Button type="submit" className="w-full md:w-auto bg-gradient-primary">
                    {form("submit")}
                  </Button>
                </form>
              </CardContent>
          ...
          >
            ...
            <div className="mt-8">
              <h3 className="font-semibold text-lg mb-4">Nos réseaux sociaux</h3>
